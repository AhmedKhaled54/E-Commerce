...
namespace Core.Migrations
{
    ...
    [Migration("20241021143043_addpaymnet")]
    partial class addpaymnet
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entity.CartEntity.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entity.CartEntity.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entity.OrderEntity.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entity.OrderEntity.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entity.WishList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entity.CartEntity.CartItem", b =>
                {
                    b.HasOne("Core.Entity.CartEntity.Cart", "Cart")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("Core.Entity.OrderEntity.Order", b =>
                {
                    ...
                    b.OwnsOne("Core.Entity.OrderEntity.ShippingAddress", "ShippingAddress", b1 =>
                        {
                            ...
                            b1.Property<string>("F_Nama")
                                .IsRequired()
                                .HasColumnType("nvarchar(max)");

                            b1.Property<string>("L_Name")
                                .IsRequired()
                                .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Core.Entity.OrderEntity.OrderItem", b =>
                {
                    b.HasOne("Core.Entity.OrderEntity.Order", "Order")
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Entity.User", b =>
                {
                    b.OwnsMany("Core.Entity.RefreshToken", "RefreshTokens", b1 =>
                        {
